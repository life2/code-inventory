...
```{r struct_stac, echo=FALSE, comment=""}
main_dir <- "C:/Users/Derek/Desktop/stac"
library(fs)
...
```{r r_code_stac, warning=FALSE, results='asis', echo=FALSE}
library(roxygen2)
library(stringr)
...
load_order <- c("/r", "/r/arch", "/r/base_reports", "/r/data", "/r/model", 
                "/r/preprocessors", "/r/rules", "/r/rules/defs", "/r/validate")
