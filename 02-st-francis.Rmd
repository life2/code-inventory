...
```{r r_code_stfrancis, warning=FALSE, results='asis', echo=FALSE}
library(roxygen2)
library(stringr)
...
load_order <- c("/r", "/r/dao", "/r/common", "/r/rules", "/r/build_dataset", 
                "/r/reports")

blocks_to_drop <- c("/r/deprecated", "/r/inpatient_main.R", "/r/analysis", 
                    "/r/sandbox")
